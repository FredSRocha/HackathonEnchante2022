          ...
          <div class="pl-6 border-green-600 px-2 py-2 flex items-center">
            ...
            <div class="flex flex-col">
                ...
                <div class="animate-pulse mx-2 text-xs font-200 relative flex">
                    <span class="flex">Appel video</span> 
        ...
        <div id="profile" class="flex flex-1 justify-center items-center">
            <div class="flex flex-col flex-1 h-full overflow-hidden overflow-y-auto items-center justify-center">
                ...
                <div class="right-heading">
                    ...
                    <p>Voulez-vous passer un appel?</p>
                    <button id="callBtn" data-user="<?php echo $profileData->userID; ?>" class="active:-top-2 relative transition shadow-md my-4 bg-pink-400 hover:bg-pink-500 p-4 px-5 rounded-full text-white text-xl"><i class="fas fa-video"></i></button>
                </div>
            </div>
        </div>
        <!--PROFILE_SECTION_END-->
