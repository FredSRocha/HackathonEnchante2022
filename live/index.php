    ...
    if($_SERVER['REQUEST_METHOD'] === "POST"){
        if(isset($_POST)){
            ...
            if(!empty($email) && !empty($password)){
                ...
                $error = "Veuillez saisir votre email et votre mot de passe pour vous connecter.";
            }
        }
    }
?>
    ...
    <div class="flex-2 flex rounded-xl w-full h-full ">
        ...
        <div class=" flex flex-1 justify-center items-center">
            <div class="flex flex-col flex-1 h-full overflow-hidden overflow-y-auto items-center justify-start">
                ...
                <div class="mt-10 w-60 h-60 right-img overflow-hidden">
                    <img class="h-auto w-full" src="assets/images/logo.png">
                </div>
            
                <div class="right-heading w-full flex flex-col items-center">
                    <div>
                        <h2 class="text-center" style="padding-top:0px;">👋 Bienvenue!</h2>
                        <p>Connectez-vous à votre destination.</p>
                    </div>
                <form method="post" class="w-full">
                 <div class="w-full flex flex-col items-center">
                    <div class="flex w-2/4 flex-col my-2 items-center">
                        ...
                        <input class="w-4/5 my-2 border border-gray-200 rounded px-4 py-2" type="password" name="password" placeholder="Le mot de passe">
                    ...
                    <div>
                    <button class="active:-top-2 relative transition shadow-md my-4 bg-pink-400 hover:bg-pink-500 p-2 px-20 rounded-full text-white text-xl">ENTRER</button>
                    </div>
                 </div>
                </form>
                </div>
